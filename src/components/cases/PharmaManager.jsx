...
const PharmacistAvailabilityManager = ({ currentUser }) => {
  ...
  const updatePharmacistStatus = async (
    status,
    reason = "",
    duration = null
  ) => {
    try {
      ...
      await updateDoc(docRef, {
        ...
        isOnline: status === 'available', // Update for room system integration
        ...additionalData,
      });

      setShowUnavailableDialog(false);
      setShowBreakDialog(false);
      setShowHolidayDialog(false); // Add this line
      setHolidayReason("");
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <p className="font-medium">
                      You are currently {getStatusIndicator()}
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <Button
                  variant={
                    availabilityStatus === "unavailable" ? "default" : "outline"
                  }
                  className={
                    availabilityStatus === "unavailable"
                ...
                <Button
                  variant={
                    availabilityStatus === "on_break" ? "default" : "outline"
                  }
                  className={
                ...
                <Button
                  variant={
                    availabilityStatus === "on_holiday" ? "default" : "outline"
                  }
                  className={
                    availabilityStatus === "on_holiday"
                  ...
                  onClick={() => handleStatusChange("on_holiday")}
                >
      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="sm:justify-between">
            ...
            <Button
              onClick={() =>
                updatePharmacistStatus("unavailable", unavailableReason)
              }
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Your status will be marked as "On Break" for {breakDuration}{" "}
                minutes.
              </p>
            </div>
          </div>
            ...
            <Button
              onClick={() =>
                updatePharmacistStatus(
                  "on_break",
                  `Taking a ${breakDuration} minute break`,
                  breakDuration
                )
              }
              disabled={updating}
      ...
      <Dialog open={showHolidayDialog} onOpenChange={setShowHolidayDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide details about your holiday period.
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="holidayReason">Holiday details</Label>
              <Textarea
                id="holidayReason"
                value={holidayReason}
                onChange={(e) => setHolidayReason(e.target.value)}
                placeholder="e.g., Annual leave, family vacation, etc."
                className="min-h-[100px]"
              />
            </div>
          </div>
          ...
          <DialogFooter className="sm:justify-between">
            ...
            <Button
              onClick={() =>
                updatePharmacistStatus("on_holiday", holidayReason)
              }
              disabled={updating || !holidayReason.trim()}
            ...
            >
              {updating ? (
                ...
                <>
                  <Plane className="h-4 w-4 mr-2" /> Mark as On Holiday
                </>
              )}
            </Button>
          </DialogFooter>
