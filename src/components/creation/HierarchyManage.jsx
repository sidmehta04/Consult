          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              >
                ...
                <DialogContent
                  className="max-w-6xl w-[90vw] !bg-white p-0 shadow-xl border border-gray-200"
                            ...
                            filteredClinics
                              ...
                              .map((clinic) => (
                                <TableRow
                                  key={clinic.id}
                                  className={
                                    clinic.isOwnClinic ? "bg-purple-50" : ""
                                  }
                                >
                  ...
                  <TableBody>
                    {filteredClinics
                      ...
                      .map((clinic) => (
                        <TableRow
                          key={clinic.id}
                          className={clinic.isOwnClinic ? "bg-purple-50" : ""}
                        >
                          <TableCell className="font-medium">
                            {clinic.name}
                            {clinic.isOwnClinic && (
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex gap-3">
            <Button
              ...
              disabled={loading}
              className="flex gap-2 items-center border-purple-300 text-purple-700 hover:bg-purple-50"
            >
              <Plus className="h-4 w-4" />
              Add Clinics
            </Button>
